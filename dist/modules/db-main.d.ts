...
export declare class OBACoreDB extends Component<OBACoreDBConfig> {
    ...
    model: <T extends mongoose.Document<any, any, any>, U extends mongoose.Model<T, {}, {}, {}>>(modelName: string, schema: mongoose.Schema<T, mongoose.Model<T, any, any, any>, {}>, collection: string) => Promise<U>;
}
